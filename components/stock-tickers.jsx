...
function StockTickers({ movers }) {
  return (
    <div className=" relative h-7 bg-primary text-primary-foreground py-2 overflow-hidden">
      <div className=" absolute top-0 animate-scroll whitespace-nowrap">
      ...
      <div className=" absolute top-0 animate-scroll-2 whitespace-nowrap">
        {movers.map((mover, index) => (
          <span key={mover.symbol} className="inline-flex items-center mx-8 ">
            <span className="font-medium">{mover.symbol}</span>
            <span className="mx-2">₹{mover.close}</span>
